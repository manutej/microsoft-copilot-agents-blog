...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section - Simplified with border */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-neutral-900 dark:text-white">
              ...
              <span className="block text-neutral-600 dark:text-neutral-400 text-3xl sm:text-4xl md:text-5xl mt-2">
                Complete Business Guide
              </span>
            </h1>
            <p className="text-xl md:text-2xl text-neutral-600 dark:text-neutral-400 mb-8 max-w-4xl mx-auto">
      ...
      {/* Stats Section */}
      <section className="bg-neutral-50 dark:bg-neutral-900 py-16 border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-accent-500 mb-2">12</div>
              <div className="text-neutral-600 dark:text-neutral-400">Comprehensive Blogs</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-accent-500 mb-2">4</div>
              <div className="text-neutral-600 dark:text-neutral-400">Learning Arcs</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-accent-500 mb-2">~180</div>
              <div className="text-neutral-600 dark:text-neutral-400">Minutes Reading Time</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-accent-500 mb-2">100%</div>
              <div className="text-neutral-600 dark:text-neutral-400">No-Code Approach</div>
            </div>
          </div>
        </div>
      </section>

      {/* Arc 1: Foundation - Bento Grid */}
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <a href="/blog/01-intro-copilot-agents" className="inline-block">
              <div className="inline-block border border-accent-500 text-accent-500 px-6 py-2 rounded-lg mb-4 hover:bg-accent-500 hover:text-white transition-all cursor-pointer">
      ...
      {/* CTA Section - Simplified with border */}
      <section className="border-t border-neutral-200 dark:border-neutral-800 bg-accent-500 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/blog/01-intro-copilot-agents"
              className="bg-white text-accent-500 px-8 py-3 rounded-lg font-semibold hover:bg-neutral-50 transition-colors border border-white"
            >
              Start with Blog 1
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-accent-500 transition-colors"
            >
